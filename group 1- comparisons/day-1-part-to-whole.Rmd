...
plot(mygraph_fw, vertex.label="", edge.arrow.size=0, vertex.size=2) +
  ggsave("day-1-part-to-whole_files/firstnetwork.png")

ggraph(mygraph_fw, layout = 'dendrogram', circular = TRUE) + 
  geom_edge_diagonal() +
  geom_node_point(aes(filter = leaf)) +
  theme_void() +
  ggsave("day-1-part-to-whole_files/circular_dendo.png")

ggraph(mygraph_fw, layout='dendrogram', circular=FALSE) + 
  geom_edge_diagonal(alpha=.4, size=.5) +
  theme_void() +
  theme(legend.position="none") +
  ggsave("day-1-part-to-whole_files/dendo.png")
...
ggraph(mygraph_fw) + 
  ...
  theme_void() +
  theme(legend.position="none")+
  ggsave("day-1-part-to-whole_files/network2.png")
